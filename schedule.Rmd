...
- Section 8.2.1 and 8.2.2 in *Introduction to Statistical Learning* (ISLR)

##### Discussion Question

Post responses in the `#daily-reading` channel on Slack by 8am.

1. What is one similiarty and one difference between bagged trees and random forests?
